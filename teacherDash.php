...
<script>
  ...
  var u_id = <?php echo $u_id?>;
   ...
   function addRollCallToClassByTeacher(student, degerler, nedenler, id, u_id, lesson){
     console.log('addRollCallToClassByTeacher');
     $.ajax({
       url:"functions/addRollCallToClassByTeacher.php",
       method: "POST",
       data: { students:student,degerler:degerler, nedenler:nedenler, id:id ,u_id:u_id, lesson_id:lesson},
       cache:false,
