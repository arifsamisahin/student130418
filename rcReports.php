...
<body>
  ...
  <div class="body hide" id="loader">
    ...
    <div class="collapse navbar-collapse" id="collapsibleNavbar">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link" href="rcReports.php" style="color:white">Reports</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="teacherProfile.php">My Profile</a>
        </li>
        <li class="nav-item">
  ...
  <!-- Recover Modal -->
  <div class="modal fade" id="modalRecover" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content" id="modalRecoverContent">
