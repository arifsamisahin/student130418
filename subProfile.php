...
<body>
  ...
  <div class="body hide" id="loader">
    ...
    <nav class="navbar navbar-expand-md bg-dark navbar-dark fixed-top">
      ...
      <a class="navbar-brand" href="index.php"><?php echo getLogo($u_id)?></a>
    ...
    <div class="collapse navbar-collapse" id="collapsibleNavbar">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link" href="subProfile.php" style="color:white">My Profile</a>
        </li>
        <li class="nav-item">
...
<script>
    ...
    var id = <?php echo $su_id?>;

    function getTeacherInfoBySelf(id){
      $.ajax({
          url:"functions/getSubuserInfoForSu.php",
          method: "POST",
          data:{id:id},
          success:function(data){
            $('#profileTeacher').html(data);
            console.log("Subuser info fetched");
