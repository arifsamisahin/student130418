...
<body>
  ...
  <div class="body hide" id="loader">
    ...
    <div class="collapse navbar-collapse" id="collapsibleNavbar">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link" href="viewTeacher.php" style="color:white">Teachers</a>
        </li>
        <li class="nav-item">
  ...
  <div id="container" class="container" style="margin-top:90px">
    ...
    <div class="row">
      ...
      <div id="reminder" class="col-lg-12 p-3"><?php echo birthdayReminderT($u_id);?></div>
    </div>
...
var u_id = <?php echo $userdata['u_id']?>;
  ...
  function getTeacherList(){
    $.ajax({
        url:"functions/teacher/getTeacherCards.php",
        method: "POST",
        data:{u_id:u_id},
  ...
  function getTeacherInfo(id){
    $.ajax({
        url:"functions/getTeacherInfo.php",
        method: "POST",
        data:{id:id},
        success:function(data){
